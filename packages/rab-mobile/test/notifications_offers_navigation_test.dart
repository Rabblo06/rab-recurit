...
import 'package:rab_staff/features/home/schedule_home_screen.dart';

import 'support/biometric_test_support.dart';

/// Regression test for a real crash: `ScheduleHomeScreen` reaches
...
void main() {
  ...
  testWidgets(
    'tapping the notification bell and the offers card on Home does not throw ProviderNotFoundException',
    (tester) async {
      ...
      await settle(tester);
      expect(find.byType(ScheduleHomeScreen), findsOneWidget);
      ...
      await tester.tap(find.text('Open Shift Offers'));
      await settle(tester);
      expect(tester.takeException(), isNull);
