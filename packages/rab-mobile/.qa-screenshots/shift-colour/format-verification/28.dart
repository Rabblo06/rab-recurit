...
void main() {
  ...
  testWidgets(
    'tapping Enable shows the unavailable dialog when the live check fails that way',
    (tester) async {
      ...
      expect(
        find.textContaining('You will use your email and password each time'),
        findsOneWidget,
      );
      expect(
        auth.phase,
        AuthPhase.authenticated,
      ); // still proceeds into the app, per the design
