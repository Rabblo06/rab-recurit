...
class BiometricLockSheetContent extends StatefulWidget {
  ...
  @override
  State<BiometricLockSheetContent> createState() => _BiometricLockSheetContentState();
}
...
class _BiometricLockSheetContentState extends State<BiometricLockSheetContent> {
  ...
  Future<void> _unlock() async {
    ...
    setState(() {
      ...
      _visual = outcome == BiometricOutcome.success ? RabBiometricVisualState.success : RabBiometricVisualState.failure;
    ...
    return StaggeredReveal(
      ...
      children: [
        ...
        Column(
          ...
          children: [
            Text('Unlock with $label', style: text.pageTitle.copyWith(fontSize: 24)),
            const SizedBox(height: AppSpace.s2),
            Text(
              _authenticating ? 'Scanning…' : 'Biometrics detected on this device. Confirm to sign in.',
              style: text.bodyMobile.copyWith(color: colors.textSecondary),
            ),
            if (_message != null) ...[
              const SizedBox(height: AppSpace.s3),
              Text(_message!, style: text.bodyMobile.copyWith(color: colors.danger)),
            ],
          ],
        ),
        Column(
            ...
            SizedBox(
              ...
              child: FilledButton(
                ...
                child: _authenticating
                    ...
                    : Text('Try again', style: text.bodyMobile.copyWith(color: Colors.white, fontWeight: FontWeight.w600)),
              ),
            ),
            const SizedBox(height: AppSpace.s3),
            Center(
