...
const verbIcons: Record<string, { Icon: any; bg: string; color: string }> = {
  ...
  sent:      { Icon: IconChecklist, bg: '#dbe9fe', color: '#1961ed' },
  confirmed: { Icon: IconChecklist, bg: '#d9f0de', color: '#2a8e44' },
  rejected:  { Icon: IconTrash,    bg: '#fdded9', color: '#d93025' },
  declined:  { Icon: IconTrash,    bg: '#fdded9', color: '#d93025' },
  withdrawn: { Icon: IconTrash,    bg: '#f1f1f1', color: '#666666' },
};
